...
<spring:message code="label.bookCreate"/>
<hr>
<form:form method="post"
           action="${pageContext.request.contextPath}/book/addsave"
           commandName="book">
    <form:errors path="*" cssClass="errorblock" element="div"/>
    <h3><spring:message code="label.createMsg"/> <input type="submit" value="<spring:message code="label.create"/>"/>
    </h3>
    <table>
        <tr>
            <td><form:label path="name"><spring:message code="label.bookName"/></form:label></td>
            <td><form:input style="width:200px" path="name"/></td>
            <td><form:errors path="name" cssClass="error"/></td>
        </tr>
        <tr>
            <td><form:label path="shortDescription"><spring:message
                    code="label.bookShortDescription"/></form:label></td>
            <td><form:textarea style="width:200px" rows="5" path="shortDescription"/></td>
